(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (## smart-mode-line monokai-theme atom-one-dark-theme solarized-theme color-theme-modern smart-mode-line-powerline-theme color-theme-solarized package-build shut-up epl git commander f dash s)))
...
;;   ;; Your init file should contain only one such instance.
;;   ;; If there is more than one, they won't work right.
;;   '(default ((t (:background nil :family "Fira Code" :slant normal :weight normal :height 18 :pixelsize 18 :width normal)))))

(set-face-attribute 'default nil
                    :family "Fira Code Retina" :height 180)
(custom-set-faces
 ;; custom-set-faces was added by Custom.
 ;; If you edit it by hand, you could mess it up, so be careful.
 ;; Your init file should contain only one such instance.
